...
<html>
				...
				<div id='container'>
					...
					<div id='body'>
						...
						<section id='content'>
						<img class='header-image' src='images/salesforce.jpg' alt='Welcome Admin' width='680' height='380' align='center'/>
						</section>
							...
							<ul>
							   <li>
									...
									<ul>
										...
										<li><a href='/assign3/addorder'>Add Customer Orders</a></li>
										<li><a href='/assign3/updorder'>Update Customer Order</a></li>
										<li><a href='/assign3/delorder'>Delete Customer Order</a></li>
