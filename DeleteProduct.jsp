...
<html>
				...
				<link rel='stylesheet' href='a11.css' type='text/css' />
				</head>
				...
				<div id='container'>
					...
					<div id='body'>
						...
						<form action='/assign3/deletep1' method='post'  autofocus>
							<header>Delete Flights</header>
							
							<label>Delete Flights</label>
							<select name='product_type' style='width:85%;margin-top:0px;margin-left:20px;'>
							<option value = 'Phone'>flights</option>
							
							</select>
							<br>
						
							<input type = 'submit' value='Delete Flight' class='center' style='margin-left:25px'  />
