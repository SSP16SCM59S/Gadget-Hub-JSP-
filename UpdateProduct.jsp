...
<html>
				...
				<div id='container'>
					...
					<div id='body'>
						...
						<form action='/assign3/updateproduct' method='post'  autofocus>
							<header>Update Flights</header>
							...
							<input type = 'submit' value='Update Flight' class='center' style='margin-left:25px'  />
